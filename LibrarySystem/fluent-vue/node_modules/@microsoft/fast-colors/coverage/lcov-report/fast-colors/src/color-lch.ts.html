...
export class ColorLCH {
     ...
     */
<span class="fstat-no" title="function not covered" >    pu</span>blic static fromObject(data: { l: number; c: number; h: number }): ColorLCH | null {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    pu</span>blic equalValue(rhs: ColorLCH): boolean {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    pu</span>blic roundToPrecision(precision: number): ColorLCH {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    pu</span>blic toObject(): { l: number; c: number; h: number } {
